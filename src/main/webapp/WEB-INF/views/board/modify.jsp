...
<form role="form" method="post">
	...
	<div class="form-group">
		<label for="inputEmail" class="sr-only">Bno</label>
        <input type="text" name="title" id="inputEmail" class="form-control" readonly="readonly"
        placeholder=" ${boardVO.bno }" required autofocus>
       
		
		<label for="inputEmail" class="sr-only">Title</label>
        <input type="text" name="title" id="inputEmail" class="form-control" placeholder="${boardVO.title }" required autofocus>
        
        <label for="inputPassword" class="sr-only">Content</label>
        <input type="text" name="content" id="inputPassword" class="form-control" placeholder=" ${boardVO.content }" required>
	
		<label for="inputName" class="sr-only">Writer</label>
        <input type="text" name="writer" id="inputName" class="form-control"  readonly="readonly"  value="${boardVO.writer }" required>
